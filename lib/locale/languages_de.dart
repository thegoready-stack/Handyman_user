...
class LanguageDe extends BaseLanguage {
  @override
  String get walkTitle1 => 'Erstellen und richten Sie Ihr Konto ein';
...
String get lblNoServicesFound => "Keine Dienste in Ihrer Zone gefunden";
  ...
  String bookingCompleted(int count) => '$count Buchung${count > 1 ? 'en' : ''} abgeschlossen';
}