...
mixin _$AppConfigurationStore on _AppConfigurationStore, Store {
  ...
  late final _$isEnableChatAtom =
      Atom(name: '_AppConfigurationStore.isEnableChat', context: context);

  @override
  bool get isEnableChat {
    _$isEnableChatAtom.reportRead();
    return super.isEnableChat;
  }

  @override
  set isEnableChat(bool value) {
    _$isEnableChatAtom.reportWrite(value, super.isEnableChat, () {
      super.isEnableChat = value;
    });
  }
  ...
  late final _$setEnableChatAsyncAction =
      AsyncAction('_AppConfigurationStore.setEnableChat', context: context);

  @override
  Future<void> setEnableChat(bool val) {
    return _$setEnableChatAsyncAction.run(() => super.setEnableChat(val));
  }
